...
const Pulang = () => {
  ...
  const submit = async () => {
    ...
    fetch('https://afanalfiandi.com/presensi/api/api.php?act=pPulang', {
      method: "POST",
      headers: {
      ...
      .then((json) => {
        if (json == 'Success') {
          Alert.alert('', 'Presensi Pulang Berhasil', [
            {
              text: 'OK',
          ...
          Alert.alert('', 'Presensi Pulang Gagal')
        }
      })
  }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.footContainer}>
          ...
          <View style={styles.submitContainer}>
            ...
            <TouchableOpacity style={styles.submitBtn} disabled={distance > 50} onPress={submit}>
